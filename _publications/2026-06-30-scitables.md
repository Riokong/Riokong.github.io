...
excerpt: 'SciTables is a dataset and framework for scientific table-to-text generation, built from peer-reviewed CS papers on arXiv (2017–2023). It pairs complex, symbol-rich tables with naturally occurring text and enables rigorous evaluation of factuality, coherence, and domain adaptation using LLM-based and embedding-based metrics.'
